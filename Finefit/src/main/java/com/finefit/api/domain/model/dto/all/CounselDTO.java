package com.finefit.api.domain.model.dto.all;

import com.finefit.api.domain.entity.CounselEntity;
import com.finefit.api.domain.model.type.DrinkingFrequencyType;
import com.finefit.api.domain.model.type.ExerciseFrequencyType;
import com.finefit.api.domain.model.type.ExerciseGoalType;
import com.finefit.api.domain.model.type.ExerciseStyleType;
...
public class CounselDTO {
  ...
  public static CounselEntity toCounselEntity(CounselDTO counselDTO) {
  ...
  public static List<CounselDTO> toCounselDTO(List<CounselEntity> counselList) {
